...
final class TemplateAppState: PrimitiveAppState {
    ...
    // `Models/models.toml` and codegen has emitted the types. Load them
    ...
    public override func connectClient() async {
        ...
        // `models.toml` (the `GeneratedModels` barrel is regenerated by
    ...
    ///
    /// Example, after adding an `ItemRecord` model to models.toml:
    ///
    ...
    public override func onDocumentOpened(
        ...
        // models in models.toml. See the example in the docstring above.
    }
}
